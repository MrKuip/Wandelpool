...
public class WandelpoolActivity2
    extends Activity
{
      ...
      Bundle savedInstanceState)
  {
    ...
    try
    {
      ...
      m_hikeAdapter = new HikeAdapter(this, R.layout.row, WandelpoolWebSite.getInstance()
                                                                           .getHikeList().getList());
  ...
  private OnItemClickListener getOnItemClickListener()
  {
    return new OnItemClickListener()
    {
          ...
          AdapterView<?> parent, View view, int position, long id)
      {
        ...
        intent = new Intent(WandelpoolActivity2.this, HikeActivity.class);
